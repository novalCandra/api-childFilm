const { modelPostRegisterAccount, modelCreateLoginAccount } = require("../model/modelUsers.module");
...
const { sendError, SendSuccess, SendSuccessAuth } = require("../helper/respon.helper");
// KEY FILES
...
const AuthLoginController = asyncHeadler(
    async (req, res) => {
        try {
